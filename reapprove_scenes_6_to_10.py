...
if proj_dir and os.path.exists(proj_dir):
    ...
    if os.path.exists(cfg_path):
        ...
        print("Updated Project_Config.json approved scenes for 06-10.")
    ...
    print("Updated agent_state.json approved scenes for 06-10.")

    print("RE-APPROVED SCENES 6 TO 10 SUCCESSFULLY!")
